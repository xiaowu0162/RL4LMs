...
class KPTimes(TextGenPool):
    ...
    def prepare(cls,
        ...
        dataset_split = KPTimes.gen_split_name(split)
        data_files = {dataset_split: '/local1/diwu/DeepKPG/data/kptimes/json/{}.json'.format(dataset_split)}
        dataset = load_dataset("json", data_files=data_files)
